...
var OpenLotePage = /** @class */ (function () {
  ...
  OpenLotePage.prototype.ngOnInit = function () {
    var _this = this;
    this.lotForm.valueChanges.subscribe(function (_) {
    ...
    this.store
      ...
      .subscribe(function (tempLoading) {
        return (_this.loading = tempLoading);
      });
    this.store
      .select(packaging_select_1.SELECT_PACKAGING_LOTS)
      .subscribe(function (lots) {
        return (_this.lots = lots);
      });
  };
  ...
  OpenLotePage.prototype.selectLot = function (evt) {
    ...
    this.store.dispatch(
      packaging_actions_1.packagingSelectLot({
        productId: productId,
        typeLots: "PACKAGING",
      })
    );
